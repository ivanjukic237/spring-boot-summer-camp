...
@Service
public class EnlistmentFormServiceImpl implements EnlistmentFormService {
    ...
    public EnlistmentFormServiceImpl(PatientRepository patientRepository, PatientModelAssembler patientModelAssembler, EnlistmentFormToPatient enlistmentFormToPatient) {
